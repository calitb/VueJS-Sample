...
export type SET_CURRENT_ITEM_ID_MUTATION = { type: 'SET_CURRENT_ITEM_ID_MUTATION'; id?: string };
...
export default {
  ...
  ['SET_CURRENT_ITEM_ID_MUTATION'](state: State, payload: SET_CURRENT_ITEM_ID_MUTATION) {
